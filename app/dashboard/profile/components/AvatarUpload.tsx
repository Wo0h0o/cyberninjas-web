    ...
    return (
        <div className="flex flex-col items-center gap-4">
            ...
            <div className="relative">
                <div className="w-32 h-32 rounded-full overflow-hidden bg-gradient-to-br from-purple-500 to-fuchsia-500 flex items-center justify-center">
                    {preview ? (
                        <img
                            src={preview}
                            alt="Avatar preview"
            ...
            <div className="flex gap-2">
                {!selectedFile ? (
                    <button
                        ...
                        disabled={uploading}
                        className="px-4 py-2 rounded-lg bg-purple-600 text-white font-medium hover:bg-purple-700 transition-colors flex items-center gap-2 disabled:opacity-50"
                    >
