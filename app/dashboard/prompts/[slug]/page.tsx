    ...
    return (
        ...
        >
            ...
            <motion.div
                ...
                className="relative w-full max-w-3xl max-h-[90vh] rounded-3xl bg-gradient-to-br from-gray-900 to-gray-950 border border-white/10 shadow-2xl shadow-purple-500/10 overflow-hidden flex flex-col"
            >
                {/* Header */}
    ...
    if (error || !library) {
        return (
            <div className="text-center py-20">
                ...
                <Link href="/dashboard/prompts" className="text-purple-400 hover:text-purple-300">
