      ...
      <section className="section">
        <div className="max-w-6xl mx-auto">
          ...
          <StaggerContainer className="grid md:grid-cols-3 gap-8" staggerDelay={0.15}>
            ...
            <StaggerItem>
              <div className="group relative h-full rounded-2xl bg-gray-900/80 border border-white/10 hover:border-purple-500/30 transition-all overflow-hidden">
                {/* Content */}
                ...
                <div className="relative h-28 overflow-hidden bg-gray-950/50">
                  ...
                  >
                    {['Перплексити', 'Stable Diffusion', 'GPT-4', 'Llama', 'Whisper', 'Suno', 'Перплексити', 'Stable Diffusion', 'GPT-4', 'Llama', 'Whisper', 'Suno'].map((tag, i) => (
            ...
            <StaggerItem>
              <div className="group relative h-full rounded-2xl bg-gray-900/80 border border-white/10 hover:border-purple-500/30 transition-all overflow-hidden">
                ...
                {/* Animated Graphic: Download icons */}
                <div className="relative h-28 overflow-hidden bg-gray-950/50">
                  <div className="absolute inset-0 flex items-center justify-center gap-6">
                    {[
                      { icon: '📄', label: 'PDF Guide' },
                      ...
                      >
                        <div className="w-14 h-14 rounded-xl bg-fuchsia-500/20 border border-fuchsia-500/30 flex items-center justify-center text-2xl">
                          {item.icon}
                        </div>
                        <span className="text-xs text-fuchsia-300/80">{item.label}</span>
                      </motion.div>
                    ))}
                  </div>
                </div>
